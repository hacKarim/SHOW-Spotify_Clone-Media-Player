          ...
          <ul className={styles.group}>
            ...
            <li className={router.asPath == '/favorites' ? styles.active : ''}>
              <Link className={styles.link} href={'/favorites'}>
                <a>
                  <Text h3>
                    <Badge color="error" variant="flat" size="md" verticalOffset="20%" horizontalOffset="20%" content={favNumber} isInvisible={favNumber == 0}>
                      <span className={styles.icon}>
                        <FiHeart />
                      </span>
                    </Badge>
            ...
            <li>
              <Text h3 style={{ cursor: 'pointer' }}>
                <span className={styles.icon} onClick={(e: any) => setTheme(theme == 'light' ? 'dark' : 'light')}>
                  {useNextTheme().theme == 'dark' ? <FiMoon /> : <FiSun color="orange" />}
                </span>
                <Switch
                  size={'md'}
                  iconOff={
